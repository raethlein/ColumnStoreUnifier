...
public void alterTableAddColumn(String tableName, String columnName) {
	NoSQLMiddleware.getImplementationHandler().alterTableAddColumn(tableName, columnName);
...
//		}
	...
	public void createNamespace(String namespaceName){
		NoSQLMiddleware.getImplementationHandler().createNamespace(namespaceName);
//		switch (NoSQLMiddleware.getUsedDatabase()) {
//		case Cassandra:
...
//		}
	...
	public void createTable(String tableName, String primaryKey) {
		NoSQLMiddleware.getImplementationHandler().createTable(tableName, primaryKey);
...
//		}
	...
	public List<String> getTableNames() {
		return NoSQLMiddleware.getImplementationHandler().getTableNames();
//		switch (NoSQLMiddleware.getUsedDatabase()) {
//		case Cassandra:
...
//		return null;
	...
	public void deleteTable(String tableName) {
		NoSQLMiddleware.getImplementationHandler().deleteTable(tableName);
//		try {
//			switch (NoSQLMiddleware.getUsedDatabase()) {
//			case Cassandra:
...
//		}
	...
	public void insertRows(String tableName, List<Row> items) {
		NoSQLMiddleware.getImplementationHandler().insertRows(tableName, items);
//		switch (NoSQLMiddleware.getUsedDatabase()) {
//		case Cassandra:
...
//		}
	...
	public Row getRowByKey(String tableName, Key... combinedKey) {
		return NoSQLMiddleware.getImplementationHandler().getRowByKey(tableName, combinedKey);
//		switch (NoSQLMiddleware.getUsedDatabase()) {
//		case Cassandra:
...
//		}
	...
	public List<Row> getRows(String tableName, String conditionalOperator, Filter... filters) {
		return NoSQLMiddleware.getImplementationHandler().getRows(tableName, conditionalOperator, filters);
//		switch (NoSQLMiddleware.getUsedDatabase()) {
//		case Cassandra:
